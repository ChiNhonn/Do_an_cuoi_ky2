...
public class SkillChart extends JPanel {

    private DefaultCategoryDataset dataset;
    private SkillChartDAO dao;

    public SkillChart() {
        dao = new SkillChartDAO();
    ...
    private void loadData() {
        dataset.clear();
        var data = dao.countAgentsPerSkill();
        for (Object[] row : data) {
            dataset.addValue((Integer) row[1], "Agents", (String) row[0]);
        }
    }
}
